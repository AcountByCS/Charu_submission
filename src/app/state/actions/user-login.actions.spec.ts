...
describe('UserLogin actions', () => {
  it('shold create an action', () => {
    const action = new UserLoginActions.AuthenticateAction({ email: 'charu@gmail.com', password: 'Charu@123' });
...
describe('UserLogin actions', () => {
  it('shold create an action', () => {
    const action = new UserLoginActions.AuthenticatedSuccessAction({ authenticated: true, user: { email: 'charu@gmail.com', password: 'Charu@123' } });
